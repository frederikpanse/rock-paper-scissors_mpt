# get cleaned data
source("get_data.R")
data_Player_A <- get_data("data_dice.csv")[1]$Player_A
data_Player_B <- get_data("data_dice.csv")[2]$Player_B
